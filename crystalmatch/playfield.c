...
unsigned char playfield_tiles[NRTILES + NRTEMPTILES][4] = // Actual IDs in video memory
{
    {128,129,130,131},
    {132,133,134,135},
    {136,137,138,139},
    ...
    {148,149,150,151},
    {152,153,154,155},
    {168,169,170,171},  // horizontal
    {172,173,174,175},  // vertical
    {176,177,178,179},  // top right
    {180,181,182,183},  // top left
    {184,185,186,187},  // bottom right
    {188,189,190,191},   // bottom left
    {156,157,158,159},   // ID 13 is a buffer for a shown cursor - never drawn by playfield_draw, only by cursor_show()
    {160,161,162,163},   // ID 14 is DROP start buffer
    {164,165,166,167}   // ID 15 is DROP end buffer
};
